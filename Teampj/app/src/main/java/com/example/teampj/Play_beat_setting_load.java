        ...
        if ( file.isDirectory() == false )        {
            if(file.isFile() == true)
            {
                ...
                if(isEx) {
                    ...
                    Log.d("노그린어레이갔냐?", String.valueOf(get_intent.getStringArrayExtra("saveColorArray")));
                    ...
                    if (get_intent.getIntExtra("select_index", -1) == -1 && get_intent.getIntExtra("signal1",-1) != 150) {
